...
Font LoadRussianFont(const char *fontPath, int fontSize)
{
    // Complete character set
    int allChars[] = {
        // Russian alphabet (33 uppercase, 33 lowercase + Ёё)
    ...
    int charCount = sizeof(allChars) / sizeof(allChars[0]);
    
    // Load font with all characters
    Font font = LoadFontEx(fontPath, fontSize, allChars, charCount);
